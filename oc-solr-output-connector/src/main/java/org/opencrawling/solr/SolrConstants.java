...
public final class SolrConstants {
    ...
    // Security Zero-Trust ACL fields
    ...
    // Dense Vector Embeddings field (Solr 9.x / 10.x DenseVectorField)
    public static final String FIELD_EMBEDDINGS = "embeddings";

    public static final String DEFAULT_FIELD_TYPE_KNN = "knn_vector";
}
