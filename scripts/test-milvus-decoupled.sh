...
echo -e "${YELLOW}Executing OIS Document Lifecycle Tombstone DELETE action test for Milvus...${NC}"
mvn test -pl oc-milvus-output-connector -Dtest=MilvusStoreWriterConsumerTest
echo -e "${GREEN}OIS Tombstone DELETE action integration step for Milvus passed!${NC}"
